<?php 
	...
	function ListarProductosInvitado()
	{
		...
		$productos = $conn->prepare("SELECT    p.idProducto
										      ,p.Nombre
										      ,p.Precio
										      ,p.Presentacion
										      ,p.Stock
										      ,p.Imagen
										      ,(SELECT COUNT(*) FROM imagenes WHERE id_producto = p.idProducto) 'cant_imagenes'
										FROM productos p");
		$productos->execute();
		$i = 0;
					...
					<div class="grid-chain-bottom">
						...
						<div class="star-price">
							<div class="dolor-grid"> 
								...
								<p class="actual">Imagenes: <?php echo $producto["cant_imagenes"]; ?></p>
							</div>
	...
	function ObtenerGaleriaProducto($id_producto)
	{
		global $conn;
