					...
					<div class="header-bottom-right">
						<ul class="login">
							<?php if (isset($_SESSION['Usuario'])): ?>
								<li><a href="?page=panel"><span></span> Bienvenido <?php echo $_SESSION['Usuario']['nombre']; ?></a></li>
								&nbsp;|&nbsp;
								<li><a href="?page=lista-usuarios">Usuarios</a></li>
								&nbsp;|&nbsp;
								<li><a href="usuario.php?action=logout">Cerrar sesión</a></li>
							<?php else: ?>
